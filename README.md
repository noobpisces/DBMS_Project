...
2. [Relational Schemas](#3-relational-schemas)
3. [Các ràng buộc cần có](#4-các-ràng-buộc-cần-có)
4. [Cài đặt các CSDL và các ràng buộc](#5-cài-đặt-các-csdl-và-các-ràng-buộc)
